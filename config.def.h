...
static const char *fonts[]                 = {"RecMonoSmCasual Nerd Font:size=12"};
static const float rootcolor[]             = COLOR(0x2E383CFF);
/* This conforms to the xdg-protocol. Set the alpha to zero to restore the old behavior */
static const float fullscreen_bg[]         = {0.1f, 0.1f, 0.1f, 1.0f}; /* You can also use glsl colors */
static uint32_t colors[][3]                = {
	/*               fg          bg          border    */
	[SchemeNorm] = { 0xD3C6AAFF, 0x1E2326FF, 0x272E33FF},
	[SchemeSel]  = { 0x1E2326FF, 0xA7C080FF, 0xA7C080FF},
	[SchemeUrg]  = { 0,          0,          0xE69875FF},
};
...
static const Key keys[] = {
	...
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_Q,                spawn, {.v = lock_scrn} },
